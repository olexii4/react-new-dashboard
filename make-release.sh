...
QUAY_REPO="quay.io/eclipse/che-dashboard:${VERSION}-react"
...
# change version for parent dashboard
sed -i "s/ARG CHE_DASHBOARD_VERSION=.*/ARG CHE_DASHBOARD_VERSION=${VERSION}/g" apache.Dockerfile
# update package.json
